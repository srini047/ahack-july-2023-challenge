...
def top_ten_plot(df):
    ...
    layout = go.Layout(
        ...
        xaxis=dict(
            ...
            title_font=dict(color="white"),  # Customize x-axis label color
            tickfont=dict(color="white"),  # Customize x-axis tick font
        ),
        yaxis=dict(
            title="Names",  # Add y-axis label
            title_font=dict(color="white"),  # Customize y-axis label color
            tickfont=dict(color="white"),  # Customize y-axis tick font
        ),
